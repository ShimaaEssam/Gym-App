...
class SignUpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSignUp.setOnClickListener OnClickListener@{
            ...
            val checker =
                    !vaild.isValidEmail(email) || !vaild.isValidPass(password) || !vaild.isValidPhone(mobile) || firstName.isEmpty() || lastName.isEmpty()
            ...
            if (checker) {
                ...
                if(!vaild.isValidEmail(email))
                    ...
                    edtEmail.error=null
                if(address.isEmpty())
                    edtAddress.error="Address is Empty"
                else
            ...
            auth!!.createUserWithEmailAndPassword(email,password).addOnCompleteListener {
                ...
                if (!it.isSuccessful) {
                    ...
                    val user: User = User(firstName,lastName,mobile,email,address,userName)
